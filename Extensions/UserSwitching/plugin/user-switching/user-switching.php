...
class user_switching {
	...
	public function action_wp_footer() {
		...
		if ( $old_user instanceof WP_User ) {
			...
			printf(
				'<p id="user_switching_switch_on" style="position:fixed;bottom:15px; right:20px;padding:0;margin:0;font-size:13px;z-index:99999; display:inline-block;"><a href="%s">%s</a></p>',
				esc_url( $url ),
				'<span title="'. esc_html(self::switch_back_message($old_user)).'">
				<span class="svg-icon svg-icon-primary svg-icon-2x"><svg xmlns="http://www.w3.org/2000/svg" width="23" height="24" viewBox="0 0 23 24" fill="none">
