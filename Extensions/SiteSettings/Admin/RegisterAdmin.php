...
namespace Addons\SiteSettings\Admin;
...
class RegisterAdmin {
	...
	public function register_admin_dashboard() {
		$primary_slug = ADDON_SLUG_SITESETTINGS;
		$parent_menu_slug = CONPHIG_MENU_SLUG;
		...
		$dashboard_page_suffix = add_menu_page(
			_x( 'Site Settings Dashboard', 'Page title', 'conphig' ),
			_x( 'Site Settings', 'Menu title', 'conphig' ),
			'manage_options',
			$primary_slug,
		...
		add_submenu_page($primary_slug, 'SiteSettings Dashboard', 'Dashboard', 'manage_options', $primary_slug . '#/dashboard', '__return_null' );
		...
		add_submenu_page( $primary_slug, 'SiteSettings Dashboard', 'Changelog', 'manage_options', $primary_slug . '#/changelog', '__return_null' );
	...
	public function enqueue_dashboard_admin_scripts() {
		$prefix = ADDON_SLUG_SITESETTINGS;
	...
	public function register_admin_bar_menu( WP_Admin_Bar $admin_bar ) {
		...
		$admin_bar->add_menu(
			array(
				'id'     => $parent_menu_id,
				'parent' => null,
				'title'  => __( 'Site Settings', 'conphig' ),
